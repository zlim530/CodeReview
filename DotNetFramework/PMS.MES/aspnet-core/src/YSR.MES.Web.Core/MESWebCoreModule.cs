...
using YSR.MES.Authentication.JwtBearer;
...
namespace YSR.MES
{
    ...
    public class MESWebCoreModule : AbpModule
    {
        ...
        public MESWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MESWebCoreModule).GetAssembly());
        }

        public override void PostInitialize()
        {
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(MESWebCoreModule).Assembly);
        }
    }
}
