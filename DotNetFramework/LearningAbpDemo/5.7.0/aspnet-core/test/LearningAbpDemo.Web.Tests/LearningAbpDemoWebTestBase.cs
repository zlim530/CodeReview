...
{
    public abstract class LearningAbpDemoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LearningAbpDemoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LearningAbpDemoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LearningAbpDemoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LearningAbpDemoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LearningAbpDemoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LearningAbpDemoDbContext, Task<T>> func)
        {
            T result;
